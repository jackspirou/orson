!
!  CURLY/TRANSLATE. Translate internal form to HTML.
!
...
!  TRANSLATE. Translate a chain of scopes SCOPES to HTML, then send SCOPES back
!  to the heap.
...
!  This is TRANSLATE SCOPE's body.  Dispatch to a translator, acccording to the
