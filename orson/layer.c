...
//  VALUE. We may add a new binder or modify a binder that already exists.
...
//  SETTING KEY. Either add a new binder to the tree P0, or modify one which is
//  already there. We use a recursive AVL algorithm that searches P0 on its way
//  down and rebalances P0 on its way back up. HIGHER tells us when one side of
//  the tree is too much deeper than the other. See:
//
