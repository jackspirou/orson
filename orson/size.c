...
//  defined sizes in bytes. No transformation type is sized. Our algorithms are
//  supposed to be compatible with GNU C's ALIGNOF and SIZEOF on an i686. Maybe
//  they're not. Maybe they work only in GNU C, or only on an i686.
