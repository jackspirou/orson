...
typedef bool          (*B)();            //  Abbreviation for REF BOOL FUNC.
typedef jmp_buf       label;             //  Target of an interfunction jump.
...
//  Structure types, in alphabetical order where possible.
...
bool      isCotype(refObject, refObject);
...
refObject sort(refObject, refObject);
...
void      writeBlanks(refStream, int);
...
bool      compiling;                    //  Will we compile TARGET PATH?
...
refChar   errToMnemonic[maxErr + 1];    //  Map errors to mnemonic strings.
refChar   errToString[maxErr + 1];      //  Map errors to descriptive strings.
...
refObject goatArgs;                     //  List of scapegoat terms.
refObject goatPars;                     //  List of scapegoat parameters.
...
refObject indJoker;                     //  Type of a CASE index.
...
refObject oldGoatArgs;                  //  Previous value of GOAT ARGS.
refObject oldGoatPars;                  //  Previous value of GOAT PARS.
...
refObject symJoker;                     //  All SYM types.
...
refObject typeSymJoker;                 //  The type of SYM JOKER.
...
bool      unlinking;                    //  Will we unlink TARGET PATH?
